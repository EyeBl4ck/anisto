...
async def comprar_cc_listfull(c: Client, m: CallbackQuery):
    kb = InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton("💳 CC Auxiliar", callback_data="cc_full full"),
            ...
            [
                InlineKeyboardButton(
                    "🏦 Buscar banco",
                    switch_inline_query_current_chat="buscarfull_banco BANCO",
                ),
                InlineKeyboardButton(
                    "🔐 Buscar bin",
                    switch_inline_query_current_chat="buscarfull_bin 550209",
                ),
            ],
            [
                InlineKeyboardButton(
                    "🏳️ Buscar bandeira",
                    switch_inline_query_current_chat="buscarfull_bandeira MASTERCARD",
                ),
            ],
[
                InlineKeyboardButton(
                    "🇧🇷 Buscar países",
                    switch_inline_query_current_chat="buscarfull_paises BR",
                ),
            ],
    ...
    await m.edit_message_text(
        f"""<a href='https://i.ibb.co/bJgz6Ly/IMG-20230711-113223-015.jpg'</a><b>💳 Comprar Cc Full</b>
...
@Client.on_inline_query(filters.regex(r"^buscarfull_(?P<type>\w+) (?P<value>.+)"))
            ...
            if live_or_die[0]:  # caso venha cc live
                ...
                kb = InlineKeyboardMarkup(
                    inline_keyboard=[
                        [
                            InlineKeyboardButton(
                                text="Acessar Loja",url="https://t.me/FenixLoginsBot"
                            ),
                        ],
                    ]
                )
